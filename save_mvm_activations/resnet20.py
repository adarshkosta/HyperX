...
root_path = '/media/akosta/DATA/Projects/Hybrid_RRAM-SRAM/saved_activations/resnet20/cifar10/'
...
#    exit(0)
    ...
    if args.mode == 'train':
        act_path = os.path.join(root_path, 'train')
        dataloader = trainloader
    elif args.mode == 'test':
        act_path = os.path.join(root_path, 'test')
